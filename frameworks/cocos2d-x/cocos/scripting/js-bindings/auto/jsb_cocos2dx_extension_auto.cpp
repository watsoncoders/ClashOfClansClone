...
bool js_cocos2dx_extension_ScrollView_isScrollEnabled(JSContext *cx, uint32_t argc, jsval *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    JS::RootedObject obj(cx, args.thisv().toObjectOrNull());
    js_proxy_t *proxy = jsb_get_js_proxy(obj);
    cocos2d::extension::ScrollView* cobj = (cocos2d::extension::ScrollView *)(proxy ? proxy->ptr : NULL);
    JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_extension_ScrollView_isScrollEnabled : Invalid Native Object");
    if (argc == 0) {
    ...
    JS_ReportError(cx, "js_cocos2dx_extension_ScrollView_isScrollEnabled : wrong number of arguments: %d, was expecting %d", argc, 0);
    return false;
}
...
bool js_cocos2dx_extension_ScrollView_setScrollEnabled(JSContext *cx, uint32_t argc, jsval *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    JS::RootedObject obj(cx, args.thisv().toObjectOrNull());
    js_proxy_t *proxy = jsb_get_js_proxy(obj);
    cocos2d::extension::ScrollView* cobj = (cocos2d::extension::ScrollView *)(proxy ? proxy->ptr : NULL);
    JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_extension_ScrollView_setScrollEnabled : Invalid Native Object");
    if (argc == 1) {
        bool arg0;
        arg0 = JS::ToBoolean(args.get(0));
        JSB_PRECONDITION2(ok, cx, false, "js_cocos2dx_extension_ScrollView_setScrollEnabled : Error processing arguments");
        cobj->setScrollEnabled(arg0);
        args.rval().setUndefined();
        return true;
    }

    JS_ReportError(cx, "js_cocos2dx_extension_ScrollView_setScrollEnabled : wrong number of arguments: %d, was expecting %d", argc, 1);
    return false;
}
...
void js_register_cocos2dx_extension_ScrollView(JSContext *cx, JS::HandleObject global) {
    ...
    static JSFunctionSpec funcs[] = {
        ...
        JS_FN("isScrollEnabled", js_cocos2dx_extension_ScrollView_isScrollEnabled, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        ...
        JS_FN("setScrollEnabled", js_cocos2dx_extension_ScrollView_setScrollEnabled, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
...
bool js_cocos2dx_extension_Manifest_prependSearchPaths(JSContext *cx, uint32_t argc, jsval *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    JS::RootedObject obj(cx, args.thisv().toObjectOrNull());
    js_proxy_t *proxy = jsb_get_js_proxy(obj);
    cocos2d::extension::Manifest* cobj = (cocos2d::extension::Manifest *)(proxy ? proxy->ptr : NULL);
    JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_extension_Manifest_prependSearchPaths : Invalid Native Object");
    if (argc == 0) {
        cobj->prependSearchPaths();
        args.rval().setUndefined();
        return true;
    }

    JS_ReportError(cx, "js_cocos2dx_extension_Manifest_prependSearchPaths : wrong number of arguments: %d, was expecting %d", argc, 0);
    return false;
}
...
void js_register_cocos2dx_extension_Manifest(JSContext *cx, JS::HandleObject global) {
    ...
    static JSFunctionSpec funcs[] = {
        ...
        JS_FN("prependSearchPaths", js_cocos2dx_extension_Manifest_prependSearchPaths, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
...
bool js_cocos2dx_extension_AssetsManagerEx_setOptionalRemote(JSContext *cx, uint32_t argc, jsval *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    bool ok = true;
    JS::RootedObject obj(cx, args.thisv().toObjectOrNull());
    js_proxy_t *proxy = jsb_get_js_proxy(obj);
    cocos2d::extension::AssetsManagerEx* cobj = (cocos2d::extension::AssetsManagerEx *)(proxy ? proxy->ptr : NULL);
    JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_extension_AssetsManagerEx_setOptionalRemote : Invalid Native Object");
    if (argc == 1) {
        std::string arg0;
        ok &= jsval_to_std_string(cx, args.get(0), &arg0);
        JSB_PRECONDITION2(ok, cx, false, "js_cocos2dx_extension_AssetsManagerEx_setOptionalRemote : Error processing arguments");
        cobj->setOptionalRemote(arg0);
        args.rval().setUndefined();
        return true;
    }

    JS_ReportError(cx, "js_cocos2dx_extension_AssetsManagerEx_setOptionalRemote : wrong number of arguments: %d, was expecting %d", argc, 1);
    return false;
}
...
bool js_cocos2dx_extension_AssetsManagerEx_getTotalToDownload(JSContext *cx, uint32_t argc, jsval *vp)
{
    JS::CallArgs args = JS::CallArgsFromVp(argc, vp);
    JS::RootedObject obj(cx, args.thisv().toObjectOrNull());
    js_proxy_t *proxy = jsb_get_js_proxy(obj);
    cocos2d::extension::AssetsManagerEx* cobj = (cocos2d::extension::AssetsManagerEx *)(proxy ? proxy->ptr : NULL);
    JSB_PRECONDITION2( cobj, cx, false, "js_cocos2dx_extension_AssetsManagerEx_getTotalToDownload : Invalid Native Object");
    if (argc == 0) {
        int ret = cobj->getTotalToDownload();
        jsval jsret = JSVAL_NULL;
        jsret = int32_to_jsval(cx, ret);
        args.rval().set(jsret);
        return true;
    ...
    JS_ReportError(cx, "js_cocos2dx_extension_AssetsManagerEx_getTotalToDownload : wrong number of arguments: %d, was expecting %d", argc, 0);
    return false;
}
...
void js_register_cocos2dx_extension_AssetsManagerEx(JSContext *cx, JS::HandleObject global) {
    ...
    static JSFunctionSpec funcs[] = {
        ...
        JS_FN("setOptionalRemote", js_cocos2dx_extension_AssetsManagerEx_setOptionalRemote, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        ...
        JS_FN("getTotalToDownload", js_cocos2dx_extension_AssetsManagerEx_getTotalToDownload, 0, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FS_END
    };
