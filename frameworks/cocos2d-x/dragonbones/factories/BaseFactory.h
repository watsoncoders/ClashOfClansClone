...
protected:
	...
	virtual Armature* generateArmature(const ArmatureData *armatureData) const { return 0; };
	virtual Slot* generateSlot(const SlotData *slotData) const { return 0; };
	virtual void* generateDisplay(const ITextureAtlas *textureAtlas, const TextureData *textureData, const DisplayData *displayData) const { return 0; };
